...
```json
{
  "media_type": "int32, 媒体类型, 取值: 0-未使用, 1-PDF文件, 2-网页, 3-Word文件, 4-PPT文件, 5-Excel文件, 6-公众号文章, 7-Markdown, 9-图片, 11-笔记, 12-QA对话, 13-TXT文本, 14-Xmind, 15-录音, 16-网页视频, 17-对话, 18-视频, 19-播客, 99-文件夹",
